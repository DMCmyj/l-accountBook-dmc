...
public class MyWebViewClient extends WebViewClient {
    ...
    private double max;
    private String[] toolTipFormat = new String[]{
            "\"<b>{b}</b><br/>总额：<b>{c}元</b>\"",
            "\"<b>{b}日</b><br/>总额：<b>{c}元</b>\"",
            "\"<b>{b}月</b><br/>总额：<b>{c}元</b>\"",
    };
    private int type;

    public MyWebViewClient(ArrayList<Double> yData, ArrayList<String> xData,double max,int type) {
        this.yData = yData;
        this.xData = xData;
        this.max = max;
        this.type = type;
